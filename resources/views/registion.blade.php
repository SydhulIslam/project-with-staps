            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="{{route('home')}}" class="app-brand-link justify-content-center">
                  <img loading="prelaod" decoding="async" class="img-fluid brand-logo" width="160" src="assets/assets/img/logo.png" alt="Wallet">
                  <span class="brand-name">Sydhul</span>
                </a>
              </div>

              <div class="app-brand justify-content-center">
                <span class="app-brand-text ">Registion</span>
              </div>
