                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li><span class="icon icon-map-marker"></span><span class="text">Lemua Bazar, Feni
                                        Sadar, Feni, Bangladesh</span></li>
                                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+880
                                            1846 166 979</span></a></li>
                                <li><a href="#"><span class="icon icon-envelope"></span><span
                                            class="text">msydhul@gmail.com</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
