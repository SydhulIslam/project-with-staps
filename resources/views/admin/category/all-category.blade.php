                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name" value="{{ old('name') }}" class="form-control"
                                        id="basic-default-name" placeholder="Category Name" />
                                </div>
                            </div>
            ...
            <div class="col-xxl">
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <form class="d-flex card-header" action="">
                                <input class="form-control me-2 rounded" type="search" value=" " name="search"
                                    id="" placeholder="Search Bar">
                                                    ...
                                                    <div class="modal-dialog modal-sm" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <select class="form-select" name= "renew_category"
